# Hi, I'm Nova Suharyanto 👋

**Full-stack Developer** from Indonesia — I build web apps end to end, from database schema to polished UI.

🌱 Started with PHP/MySQL, now shipping with modern full-stack tools.
...
- **Other:** Python · Streamlit · Google GenAI
...
*Currently open to remote full-stack developer opportunities.*
